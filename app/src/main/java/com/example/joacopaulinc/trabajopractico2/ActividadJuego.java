...
public class ActividadJuego extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Bundle obtieneExtras;
        obtieneExtras = this.getIntent().getExtras();

        nombreJugador = obtieneExtras.getString("nombreJugador");
        cantPartidas = obtieneExtras.getInt("cantidadPartidas");
        record = obtieneExtras.getInt("record");
    ...
    public void Resto(boolean ganaPorMi, int record, int movimientosActuales)
    {
        if(Gano())
        {
            if(!ganaPorMi)
            ...
            {
                Intent ActividadDestino;
                ActividadDestino = new Intent(ActividadJuego.this, ActividadChanta.class);
                startActivity(ActividadDestino);
            }
        }
    }
    ...
    public void InvertirCostados(int num)
    {
        ...
        Resto(ganaPorMi, record, cantMovimientos);
    }
